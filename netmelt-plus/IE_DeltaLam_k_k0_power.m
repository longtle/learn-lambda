function [TOutput, eigenScore, eigenGap] =  IE_DeltaLam_k_k0_power(A,k, k0, flag, recompute)
...
%We improve by using power iteration, or using the eigenvector from
%previous steps
